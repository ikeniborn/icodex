...
assert_contains "root README diagrams governance artifacts" "$root_readme" "Required: attempts.jsonl automation record"
...
assert_contains "root Russian README diagrams governance artifacts" "$root_readme_ru" "Обязательно: attempts.jsonl automation record"
