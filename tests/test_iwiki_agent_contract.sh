...
assert_contains "modes name the defaulted specification search" "$flat_modes_body" 'a `wiki_spec_search` without `domains` reports `token_default` or `binding_defaulted`'
