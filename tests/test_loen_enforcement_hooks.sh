...
assert_malformed_runtime_authority "tool-guard rejects wrong-even unknown mapping" "tool-guard.py" "strict" "$test_edit" $'    - search\n    - apply_patch' $'    - search\n    metadata:\n    - edit'
assert_malformed_runtime_authority "scope-guard rejects wrong-even unknown mapping" "scope-guard.py" "enforce" "$outside_edit" $'      - src/**\n      - tests/**' $'      - src/**\n      metadata:\n      - outside/**'
