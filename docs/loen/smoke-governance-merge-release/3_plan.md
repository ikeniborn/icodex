...
- Verifier: `test -s docs/loen/smoke-governance-merge-release/evidence/release-dry-run.txt`
...
```bash
test -s docs/loen/smoke-governance-merge-release/evidence/release-dry-run.txt
```
