...
| loen-overview | in-progress | n/a | – | – | – | 2026-07-02 |  | Umbrella design for standalone LoEn loop-engineering plugin and layer sequencing |
| loen-plugin-core | in-progress | n/a | – | – | – | 2026-07-02 |  | LoEn plugin source tree, manifest, skills, hooks, agents, and templates |
| loen-runtime-artifacts | in-progress | n/a | – | – | – | 2026-07-02 |  | Topic artifacts under docs/loen/<topic>/ with numbered stages and audit.html |
| loen-enforcement-hooks | in-progress | n/a | – | – | – | 2026-07-02 |  | Independent LoEn loop gates, scope guard, tool guard, permission guard, and evidence gate |
| loen-agent-isolation | in-progress | n/a | – | – | – | 2026-07-02 |  | Role-specific agents, context capsules, Codex profile split, and WASM-first verifier isolation |
| loen-icodex-integration | in-progress | n/a | – | – | – | 2026-07-02 |  | Vendor and launch-time wiring for LoEn as a standalone Codex plugin in icodex |
| loen-automation-governance | in-progress | n/a | – | – | – | 2026-07-02 |  | Later L3 automation and governance rules after manual loops prove stable |
