...
| icodex-idd-unify | in-progress | n/a | ✓ | ✓ | – | 2026-07-01 |  | Unify IDD chain: single chain-gate.py + check-chain + fix-intent (replaces split 2 hooks + 4 check-* + intent); full migration keeps IDD tests green; spec+plan check-chain OK (1 WARNING F-001 fixed: spec/plan tab-token wording reconciled) |
