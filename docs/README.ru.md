...
`--update` качают только бинарь Codex; `--update` печатает каждую стадию сети/установки с
прогресс-баром скачивания curl. Плагин Superpowers и скиллы едут через git и обновляются
только мейнтейнерскими скриптами.
